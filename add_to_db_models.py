...
class UnitItemAssociation(Base):
    ...
    def __repr__(self) -> str:
        return f"UnitSkillAssociation(unit_nid={self.unit_nid!r}, skill_nid={self.item_nid!r}, is_droppable={self.is_droppable!r})"
